...
function reply_click(nowId) {
    ...
    const currentOrder = Orders[nowId - 1];

    updateProductsTableView(currentOrder.products)
    ...
    shipCity.innerHTML = "City: " + currentOrder.ShipTo.Region;
...
function getCustomerInfo(nowId) {
    ...
    shipCode.innerHTML = "Address: " + currentOrder.CustomerInfo.address;
    shipCity.innerHTML = "Phone: " + currentOrder.CustomerInfo.phone;
    shipCountry.innerHTML = "E-Mail: " + currentOrder.CustomerInfo.email;
}
//order count
